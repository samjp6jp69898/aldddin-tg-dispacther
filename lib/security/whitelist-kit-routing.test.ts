...
const KIT_ADMIN_CHAT_ID = 5022865804 // Landon，見 test-support/tech-user-fixture.ts／.env TG_KIT_ADMIN_CHAT_ID 真實值
// 另一位真實白名單內技術（Blast，非 kit admin）。原本用 Eden Li KHH，
